...
//ol.proj.get("EPSG:3857").setExtent([-134292.961908, 6550898.998534, 46271.126143, 6663517.489008]);
var wms_layers = [];
...
lyr_Optimizednetworksitesallsites_2.set('fieldLabels', {'Site ID': 'no label', 'Longitude': 'no label', 'Latitude': 'no label', 'Site Owner': 'no label', 'Forecast': 'no label', });
